...
This page gives a brief introduction to fNIRS and to the way Cedalion handles fNIRS data.
...
- **Channel**: a source–detector pair. A single detector can form channels with multiple
  ...
  *S × D* channels.
- **Optode**: a collective term for sources and detectors, similar to electrodes in an EEG.
