...
- Previously, HRF regressors in the GLM where constructed from normalized basis functions and normalized again after they were convolved over the stimulus duration. Now, only the basis functions are normalized to 1.
