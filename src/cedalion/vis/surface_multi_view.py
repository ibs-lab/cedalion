...
def surface_multi_view( X_ts, head, clim=None, view_type='hbo_brain', title_str=None, filename=None, SAVE=False, SAVE_GIF=False, frame_indices=None, fps=6 ):
    """
    Generate a multi-view 3D visualization of brain or scalp data projected onto a head mesh,
    with optional saving as a static image or animated GIF over time.
    ...
    filename : str, optional
        Path and base name for saving the static PNG image or animated GIF. Required if SAVE or SAVE_GIF is True.
