...
def scalp_plot_gif( data_ts: cdt.NDTimeSeries, geo3d: cdt.LabeledPointCloud, frame_range, 
                   filename: str, scl=None, fps: int =10, optode_size: float = 6, optode_labels: bool =False, 
                   str_title: str =''):
