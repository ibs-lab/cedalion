...
def psp(
    ...
    cite("Pollonini2014", "peak spectral power quality metric")
    cite("Pollonini2016", "peak spectral power quality metric")
...
def gvtd(amplitudes: NDTimeSeries, stat_type: str = "default", n_std: int = 10):
    ...
    cite("Sherafati2020", "GVTD motion detection metric")
    fcut_min = 0.01
    fcut_max = 0.5
...
def sci(
    ...
    cite("Pollonini2014", "scalp-coupling index quality metric")
    cite("Pollonini2016", "scalp-coupling index quality metric")
...
def detect_outliers_std(
    ...
    cite("Jahani2018", "motion artifact detection")
